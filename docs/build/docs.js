...
assign$1(Modal.prototype, template$2.methods, proto$1 );
...
Modal.prototype._recompute = function _recompute(changed, state, oldState, isInitial) {
	if ( isInitial || changed.hiding || changed.opening ) {
		if (differs$1((state.transitioning = template$2.computed.transitioning(state.hiding, state.opening)), oldState.transitioning)) changed.transitioning = true;
	}

	if ( isInitial || changed.hidden || changed.transitioning ) {
		if (differs$1((state.open = template$2.computed.open(state.hidden, state.transitioning)), oldState.open)) changed.open = true;
	}

	if ( isInitial || changed.zIndexBase || changed.inForeground ) {
		if (differs$1((state.zIndex = template$2.computed.zIndex(state.zIndexBase, state.inForeground)), oldState.zIndex)) changed.zIndex = true;
	}
};
...
function Dialog$1 ( options ) {
	this.options = options;
	this.refs = {};
	this._state = assign$1$1( template$1.data(), options.data );
...
assign$1$1( Alert.prototype, template$3.methods, proto$1$1 );
...
function Confirm ( options ) {
	this.options = options;
	this.refs = {};
	this._state = assign$1$1( template$4.data(), options.data );
...
assign$1$1( Confirm.prototype, template$4.methods, proto$1$1 );
...
function create_main_fragment ( state, component ) {
	var div, h1, text, text_1, fieldset, legend, text_2, text_3, ul, li, label, input, input_updating = false, text_4, li_1, label_1, input_1, input_1_updating = false, text_6, li_2, label_2, input_2, input_2_updating = false, text_8, text_11, text_12, text_13, button, text_14, text_16, if_block_2_anchor;
	...
	return {
		create: function () {
			...
			text_12 = createText$1( "\n\n  " );
			if ( if_block_1 ) if_block_1.create();
			text_13 = createText$1( "\n\n  " );
			button = createElement$1$1( 'button' );
			text_14 = createText$1( "Open Dialog" );
			text_16 = createText$1( "\n\n" );
		...
		mount: function ( target, anchor ) {
			...
			appendNode$1$1( h1, div );
			appendNode$1$1( text, h1 );
			appendNode$1$1( text_1, div );
			appendNode$1$1( fieldset, div );
			...
			appendNode$1$1( text_11, div );
			if ( if_block ) if_block.mount( div, null );
			appendNode$1$1( text_12, div );
			if ( if_block_1 ) if_block_1.mount( div, null );
			appendNode$1$1( text_13, div );
			appendNode$1$1( button, div );
			appendNode$1$1( text_14, button );
			insertNode$1$1( text_16, target, anchor );
			if ( if_block_2 ) if_block_2.mount( target, anchor );
			insertNode$1$1( if_block_2_anchor, target, anchor );
		},
		...
		unmount: function () {
			...
			detachNode$1$1( text_16 );
			if ( if_block_2 ) if_block_2.unmount();
			detachNode$1$1( if_block_2_anchor );
		},
...
function create_if_block ( state, component ) {
	...
	return {
		...
		mount: function ( target, anchor ) {
			insertNode$1$1( div, target, anchor );
			appendNode$1$1( label, div );
			appendNode$1$1( text, label );
			appendNode$1$1( input, label );
...
function create_if_block_1 ( state, component ) {
	...
	return {
		...
		mount: function ( target, anchor ) {
			...
			appendNode$1$1( legend, fieldset );
			appendNode$1$1( text, legend );
			appendNode$1$1( text_1, fieldset );
			appendNode$1$1( ul, fieldset );
			appendNode$1$1( li, ul );
			appendNode$1$1( label, li );
			appendNode$1$1( input, label );
...
function create_if_block_3 ( state, component ) {
	...
	alert$$1.on( 'hidden', function ( event ) {
		component.set({ dialogOpen: false });
	});

	return {
		create: function () {
			alert$$1._fragment.create();
		},

		mount: function ( target, anchor ) {
			alert$$1._fragment.mount( target, anchor );
		},

		update: function ( changed, state ) {
			var alert_changes = {};
			if ( changed.dialogOptions ) alert_changes.initialFocus = state.dialogOptions.alert.initialFocus;
			alert$$1._set( alert_changes );
		},

		unmount: function () {
			alert$$1._fragment.unmount();
		},

		destroy: function () {
			alert$$1.destroy( false );
		}
	};
}
...
function create_if_block_4 ( state, component ) {
	...
	confirm$$1.on( 'result', function ( event ) {
		component.set({ confirmed: event && event.confirmed });
	});

	confirm$$1.on( 'hidden', function ( event ) {
		component.set({ dialogOpen: false });
	});

	return {
		create: function () {
			confirm$$1._fragment.create();
		},

		mount: function ( target, anchor ) {
			confirm$$1._fragment.mount( target, anchor );
		},

		update: function ( changed, state ) {
			var confirm_changes = {};
			if ( changed.dialogOptions ) confirm_changes.defaultAction = state.dialogOptions.confirm.defaultAction;
			confirm$$1._set( confirm_changes );
		},

		unmount: function () {
			confirm$$1._fragment.unmount();
		},

		destroy: function () {
			confirm$$1.destroy( false );
		}
	};
}
...
function create_if_block_2 ( state, component ) {
	...
	return {
		...
		mount: function ( target, anchor ) {
			...
			insertNode$1$1( text, target, anchor );
			if ( if_block_4 ) if_block_4.mount( target, anchor );
			insertNode$1$1( if_block_4_anchor, target, anchor );
		},
		...
		unmount: function () {
			...
			detachNode$1$1( if_block_4_anchor );
		},
